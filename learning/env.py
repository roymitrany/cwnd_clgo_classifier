...
training_files_path = os.path.join(absolute_path, cnn_train_and_test_files_directory, r'unfixed_host_bw_srv_bw_with_random_timing')
...
graphs_path = os.path.join(absolute_path, r'graphs/average_calculation_with_retransmits/')
