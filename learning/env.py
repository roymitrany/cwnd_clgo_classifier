...
training_files_path = '/data_disk/classification_data/with_data_repetition/queue_size_500/tcp_noise/START_AFTER/30_bbr_cubic_reno_background_flows'
...
NUM_OF_TIME_SAMPLES = 60000# 9499 # 9499 # 60000
...
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/online vs offline/30 background flows/offline/', str(BG_FLOW) + "_bg_flows_")
