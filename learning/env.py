...
training_files_path = '/data_disk/no_filter'
...
END_BEFORE = 0
BG_FLOW = 0
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/online_classification/sampling rate/9499 chunk size', "online_filtering", str(BG_FLOW) + "_bg_flows")
