...
training_files_path = os.path.join(absolute_path, cnn_train_and_test_files_directory, r'75_background_flows')
...
graphs_path = os.path.join(absolute_path,r'graphs/thesis_prime/online_classification/sampling rate/9499 chunk size/75 background flows/')
