...
NUM_OF_TIME_SAMPLES = 10000#9499# 10000 #60000# 9499 # 9499 # 60000
NUM_OF_HIDDEN_LAYERS = 100
CHUNK_SIZE = 10000#9499#10000#9499 # 9499
DEEPCCI_NUM_OF_TIME_SAMPLES = 10#int(CHUNK_SIZE / 1000)
...
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/diverse chunk sizes/15 background flows/diverse seconds/session_sample CBIQ initialised to 0/0 filter/MyDeepcci/100', str(BG_FLOW) + "_bg_flows_")
