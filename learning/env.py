...
training_files_path = os.path.join(absolute_path, cnn_train_and_test_files_directory, r'START_AFTER/75_bbr_cubic_reno_background_flows')
...
graphs_path = os.path.join(absolute_path, r'graphs/unfixed_session_duration/bbr_cubic_reno_background_tcp_flows_with_all_parameters/75_background_tcp_flows/')
