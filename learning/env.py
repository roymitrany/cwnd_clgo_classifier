...
#training_files_path = os.path.join(absolute_path, cnn_train_and_test_files_directory, r'15_bbr_cubic_reno_background_flows')
...
#graphs_path = os.path.join(absolute_path, r'graphs/unfixed_session_duration/0_background_tcp_flows/')
...
for IS_DEEPCCI in [False, True]:
    ...
    for flow in number_of_flows:
        ...
        graphs_path = os.path.join(absolute_path, r'graphs/unfixed_session_duration/bbr_cubic_reno_background_tcp_flows_with_all_parameters/' + dir)
