...
cnn_train_and_test_files_directory = r'/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/asymetric traffic/'
...
training_files_path = '/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/physical data/filtered_data_o'
...
training_files_path = '/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/discrete_bg/filtered_data'
training_files_path = '/data_disk/physical data/diverse_bg/filtered_data_0_filter'
training_files_path = '/data_disk/physical data/discrete_bg/filtered_data_0_filter'
training_files_path = '/data_disk/physical data/discrete_bg/filtered_data_0_CBIQ_initialised_to_0'
training_files_path = '/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/physical data/filtered_data_0'
training_files_path = '/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/physical_data/60 seconds/filtered_data_0'
#training_files_path = '/data_disk/physical data/discrete_bg/filtered_data_0_filter_interpolation_after_calculation'
#training_files_path = '/home/dean/PycharmProjects/cwnd_clgo_classifier/classification_data/discrete_bg/filtered_data'
#training_files_path = '/data_disk/online filtering/random_interpolation_filter_0.5'
#training_files_path = '/data_disk/physical data/diverse_bg/filtered_data_0.9_filter'
#training_files_path = '/data_disk/physical data/diverse_bg/filtered_data_0_filter'
...
diverse_training_folder = [r'filtered_0', r'filtered_0.5', r'filtered_0.9']
...
#graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/15 background flows/diverse seconds/session_sample/0 filter/0.1/', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/15 background flows/diverse seconds/session_sample CBIQ initialised to 0/0 filter/1000 old norm/', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/diverse background flows/5 seconds/0 filter/CBIQ/75 background flows/', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/rtt classification/session sample/0 background flows/0 filter/Deepcci/100', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/diverse background flows/10 seconds/0 filter/CBIQ/75 background flows', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification- Results26-29/discrete_bg/diverse chunk sizes/15 background flows/diverse seconds/session_sample CBIQ initialised to 0/0 filter/Deepcci/1000', str(BG_FLOW) + "_bg_flows_")
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification- Results26-29/discrete_bg/60 seconds/diverse chunk sizes/15 background flows/0 filter', str(BG_FLOW) + "_bg_flows_")
#graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification- Results26-29/discrete_bg/diverse background flows/10 seconds/0 filter/Deepcci/75 background flows', str(BG_FLOW) + "_bg_flows_")
#graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification- Results26-29/discrete_bg/diverse filter/15 background flows/1 seconds/0', str(BG_FLOW) + "_bg_flows_")

#graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/full session vs sample/15 background flows/1 seconds/0 filter/full session/CBIQ/', str(BG_FLOW) + "_bg_flows_")
#graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/75 background flows/1 seconds/session sample/0 filter/', str(BG_FLOW) + "_bg_flows_")
