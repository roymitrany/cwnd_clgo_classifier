...
CHUNK_SIZE = 1000#9499#10000#9499 # 9499
...
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/physical_classification/discrete_bg/diverse background flows/1 seconds/0 filter/CBIQ/75 background flows/', str(BG_FLOW) + "_bg_flows_")
