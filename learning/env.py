...
training_files_path = '/data_disk/random_interpolation_filter_0'
...
END_BEFORE = 0
BG_FLOW = 5 # 10
graphs_path = os.path.join(absolute_path, r'graphs/thesis_prime/online_classification/sampling rate/10000 chunk size', "online_filtering/random_filtering/in_and_out_interpolation", str(BG_FLOW) + "_bg_flows")
